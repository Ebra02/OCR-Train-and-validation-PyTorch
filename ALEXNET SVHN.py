...
# Define the dataset and data loaders (SVHN as an example)
...
dataset = SVHN(root='./data', split='train', transform=transform, download=True)  # Use 'train' split
...
# Define AlexNet with the correct number of output classes (10 for SVHN)
...
print(f"Testing Accuracy for AlexNet on SVHN: {accuracy:.2f}%")
