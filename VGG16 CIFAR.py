...
# Define VGG16
model = models.vgg16(pretrained=False, num_classes=10)  # Update the number of output classes to 10 for CIFAR-10
...
with torch.no_grad():
    ...
    print(f"Testing Accuracy for VGG16 on CIFAR-10: {accuracy:.2f}%")
