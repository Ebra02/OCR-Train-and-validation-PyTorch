...
from torchvision import models  # Import AlexNet
...
transform = transforms.Compose([
    transforms.Resize((224, 224)),  # Resize the input images to 224x224
    transforms.ToTensor(),
...
# Define AlexNet and move it to the GPU
device = torch.device("cuda:0" if torch.cuda.is_available() else "cpu")

model = models.alexnet(pretrained=False, num_classes=len(custom_dataset.classes)).to(device)
